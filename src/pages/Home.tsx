...
function Home() {
  return (
    <div className=" text-black h-full w-full flex flex-col">
      ...
      <section className="bg-[#C4DAD2] relative pt-4 top-11 w-full max-md:top-0 max-md:pt-5 grid grid-cols-12 px-7 mt-2 gap-8">
        <div className="col-span-6 max-sm:col-span-12">
          ...
          <p>Depuis un an, nous avons la chance de gérer ces terres. Nous visons à les développer avec de nouveaux
            espaces et à maintenir des terrains bien entretenus pour vous offrir un camping de qualité.</p>
        </div>
        <div className="col-span-6 max-sm:col-span-12 pb-10">
